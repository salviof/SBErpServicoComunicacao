 ...
 */
package br.com.casanovadigital.servicos.chat.legado.chat.controller.whatsapp;
...
public class ApiWhatsappRecepcaoMensagem extends RotaSparkPadrao {
    ...
    public String executarRegraDeNegocio() throws ErroRegraDeNegocio, ErroRecursoNaoEncontrado, ErroConexaoSistemaTerceiro {
        ...
        for (MensagemWhatsapp msg : getPacoteMensagem().getMensagens()) {
            try {
        ...
        for (EventoMensagemWtzap statusMensagem : getPacoteMensagem().getStatusMensagem()) {
            try {
        ...
        getPacoteMensagem().getStatusMensagem();
        return "ok";
    }
