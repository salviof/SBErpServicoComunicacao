 ...
 */
package br.com.casanovadigital.servicos.notificacao.interpretadormsg.modelDTO.whatsapp.statusMensagem;
...
public enum FabTipoStatusMensagemWhtzap {
    ...
    public static EventoMensagemWtzap gerarStatusMensgem(EntradaNumeroWhatsapp pEntrada, JsonObject pMetadata, JsonObject pJson) {
        try {
