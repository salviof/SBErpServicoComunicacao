...
public class ServicoWhatsappTest {
    ...
    public void testEnviarImagem() throws Exception, ErroConexaoServicoChat {
        ...
        byte[] arquivo = UtilCRCBytes.gerarBytesPorArquivo(new File("/home/superBits/projetos/coletivoJava/source/erpColetivoJava/SBErpServicoComunicacao/ws/src/test/resources/arquivos/teste.pdf"));
