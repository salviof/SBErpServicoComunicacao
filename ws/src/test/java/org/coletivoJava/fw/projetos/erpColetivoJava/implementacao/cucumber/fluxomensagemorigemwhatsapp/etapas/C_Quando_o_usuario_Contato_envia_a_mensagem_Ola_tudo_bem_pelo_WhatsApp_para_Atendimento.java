...
public class C_Quando_o_usuario_Contato_envia_a_mensagem_Ola_tudo_bem_pelo_WhatsApp_para_Atendimento {
    ...
    public void implementacaoEtapa() {
        ...
        RespostaHttpResumo resp = UtilTestesSpark.criarRequisicao(ApiWhatsappRecepMensagem.class, FluxoMensagemOrigemWhatsapp.MENSAGEM_whatsapp_SIMPLES_payload);
        Assert.assertEquals("Requisição de registro de mensagem foi negada" + resp.getCorpoTexto(), 200, resp.getStatus());
    }
}
